...
$f \textrm{surriettiva} \Leftrightarrow f(Z^2) = 2$ \newline
e che quindi:
$f(Z^2) = {n \in Z : \exists(x,y) \in Z^2 n=f(x,y)=21x - 15y} $

Quella che abbiamo appena scritto è una funzione \textbf{Diofantea} ovvero $MCD(21,15) : n \Leftrightarrow f(Z^2)={3k : k \in Z}$
